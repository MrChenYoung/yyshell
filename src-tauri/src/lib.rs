...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            ssh::start_monitoring,
            ssh::stop_monitoring,
            ssh::ssh_exec_command,
            // russh commands (new implementation)
            ssh_russh::russh_connect,
            ssh_russh::russh_disconnect,
            ssh_russh::russh_write_pty,
            ssh_russh::russh_resize_pty,
            sftp::init_sftp,
            sftp::sftp_list_dir,
            sftp::sftp_mkdir,
            ...
            sftp::sftp_rename,
            sftp::sftp_rmdir,
            sftp::sftp_cancel_download,
            sftp::sftp_download_folder,
            sftp::sftp_read_file,
            sftp::sftp_write_file,
            sftp::sftp_read_file_base64,
            sftp::sftp_open_with_system,
            sftp::sftp_cleanup,
            ...
            commands::add_quick_command,
            commands::update_quick_command,
            commands::delete_quick_command,
            commands::load_tunnel_presets,
            commands::save_tunnel_presets,
            commands::add_tunnel_preset,
            commands::update_tunnel_preset,
            commands::delete_tunnel_preset,
            commands::load_tunnel_category_order,
            commands::save_tunnel_category_order,
            commands::rename_tunnel_category,
            commands::delete_tunnel_category,
            // Script commands
            commands::load_scripts,
            commands::add_script,
            commands::update_script,
            commands::delete_script,
            commands::save_scripts_batch,
            port_forward::start_port_forward,
            port_forward::stop_port_forward,
            port_forward::list_port_forwards,
            // Plugin commands
            plugin_commands::list_plugins,
            plugin_commands::install_plugin_local,
            plugin_commands::install_plugin_github,
            plugin_commands::uninstall_plugin,
            plugin_commands::set_plugin_enabled,
            plugin_commands::check_plugin_updates,
            plugin_commands::call_plugin_method,
            plugin_commands::get_plugin_contributions,
            plugin_commands::fetch_marketplace,
            plugin_commands::install_from_marketplace,
